...
const theBoards = {
    american: {
        ...
        wineInfo: "For a creamy and buttery cheese like American, a crisp, acidic white like Suavignon Blanc or Chardonnay, provides a light fruity flavor that compliments the mild American while also cutting through the Gorgonzola. A fruit-forward red like a Pinot Noir or Beaujolais adds a sweet zing that will be a surefire compliment to all three cheeses, but especially your Provolone!",
        knife1: "Flat knife",
...
export default theBoards

{/*When it all gets returned in the html page, it's gonna look like: {theBoards.american.bigCheese}*/}